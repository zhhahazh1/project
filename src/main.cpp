...
int main(int argc, char *argv[]) {
    ...
    std::string desing_aera = "../exapmle/case30000/design.are";
    std::string desing_net = "../exapmle/case30000/design.net";
    std::string desing_info = "../exapmle/case30000/design.info";
    std::string desing_topo = "../exapmle/case30000/design.topo";
    ...
    // buildSparsifiedHypergraph(hyperGraph,10,10000,10000);
